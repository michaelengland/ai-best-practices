...
- **Total sections**: 7
- **Estimated slides**: ~68 (billboard design — one idea per slide)
...
**Key message**: AI is simpler than the jargon makes it seem. The gap between using AI and using it well is massive.
**Content**:
- Buzzword blizzard (intentional overwhelm)
- Questions from the chaos (ChatGPT vs GPT? What's an agent?)
- AI stack: App → Agent → API → LLM
- Who makes what (table)
- "The real action is in agents and apps."
- 41% of GitHub code AI-generated (Second Talent) / 19% longer without understanding (Addy Osmani) / 10× Copilot growth (Microsoft Q2 2026)
...
- Breather transition
**Emphasis**: High (the Wrong/Right slides are the most visually distinctive in the deck)
